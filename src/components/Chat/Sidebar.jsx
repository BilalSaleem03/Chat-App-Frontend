...
const IconChat = () => (
  ...
  // </svg>
  <img  className="sidebar__nav-icon" src="/src/assets/sidebar-chat2.png" alt="Chat Icon" />
);
const IconBox = () => (
  // <svg className="sidebar__nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  //   <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/>
  // </svg>
  <img  className="sidebar__nav-icon" src="/src/assets/sidebar-product.png" alt="Product Icon" />
);
const IconCart = () => (
  // <svg className="sidebar__nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  // </svg>
  <img  className="sidebar__nav-icon" src="/src/assets/sidebar-orders.png" alt="Product Icon" />
);
const IconUser = () => (
  // <svg className="sidebar__nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  // </svg>
  <img  className="sidebar__nav-icon" src="/src/assets/sidebar-customers.png" alt="Product Icon" />
);
const IconStore = () => (
  // <svg className="sidebar__nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  // </svg>
  <img  className="sidebar__nav-icon" src="/src/assets/sidebar-seller.png" alt="Product Icon" />
);
const IconFolder = () => (
  // <svg className="sidebar__nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  //   <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/>
  // </svg>
  <img  className="sidebar__nav-icon" src="/src/assets/sidebar-file.png" alt="Product Icon" />
);
    ...
    <div className="sidebar__header">
      {
        collapsed ? <button className="sidebar__toggle" onClick={onToggle} aria-label="Toggle sidebar">
                      <img style={{transform: 'scaleX(-1)' ,marginLeft: '1rem'}} src="/src/assets/toggle-arrow.svg" alt="arrow" />
                    </button>
        : <Link to="/" className="sidebar__logo">
            <span className="sidebar__logo-icon">
              <img src="/src/assets/Logo-icon.png" alt="" aria-hidden="true" />
            </span>
      ...
      <button className="sidebar__toggle" onClick={onToggle} aria-label="Toggle sidebar">
        <img src="/src/assets/toggle-arrow.svg" alt="arrow" />
      </button>
    </div>

...
const Register = ({ onRegister }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        let response = await axios.post(`${backendUrl}/users/register`,  {
            name: form.name,
        ...
        // Parse the MongoDB duplicate key error string on frontend
  ...
  return (
    <AuthLayout footer="© 2025 Made For Test Task">
      <div className="register">
        ...
        <button type="button" className="register__google-btn" onClick={() => { window.location.href = '/api/auth/google'; }}>
        ...
        <form className="register__form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="register__field">
            ...
            <div className="register__input-wrap">
              ...
              />
              <button type="button" className="register__eye-btn" onClick={() => setShowPass(v => !v)} aria-label={showPass ? 'Hide password' : 'Show password'}>
          ...
          <div>
            <label className="register__terms">
              <input type="checkbox" name="agreed" className="register__checkbox" checked={form.agreed} onChange={handleChange} />
